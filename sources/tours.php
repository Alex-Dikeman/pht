  ...
  <div id="wrapper">
    ...
    <nav>
      <ul>
        ...
        <li><a href="../reservations/reservations.html.php">Reservations</a></li>
    ...
    <main>
      <table>
        ...
        <tr>
          ...
          <td class="reserve"><a href="../reservations/reservations.html.php">Reserve</a></td>
        </tr>
        <tr>
      ...
      <h1>Downtown Tour</h1>
        ...
        <a href="../reservations/reservations.html.php" class="reserve"><div>Reserve</div></a>
        <br class="clearright">
      <h1>Growth Tour</h1>
    ...
    <footer>
      <div class="footernav">
        ...
        <a href="../reservations/reservations.html.php">Reservations</a>
